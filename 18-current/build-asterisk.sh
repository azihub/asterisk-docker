...
menuselect/menuselect --enable format_mp3 --enable app_mysql --enable res_config_mysql --enable cdr_mysql --enable app_saycountpl --enable app_skel --enable app_fax --enable app_ivrdemo --enable app_saycounted --enable app_readfile --enable app_setcallerid --enable res_pktccops --enable res_fax --enable res_fax_spandsp --disable BUILD_NATIVE --enable G711_NEW_ALGORITHM --enable G711_REDUCED_BRANCHING --enable ODBC_STORAGE --enable CORE-SOUNDS-EN-WAV --enable CORE-SOUNDS-EN-ULAW --enable CORE-SOUNDS-EN-ALAW --enable CORE-SOUNDS-EN-G729 --enable CORE-SOUNDS-EN-G722 --enable MOH-OPSOUND-ULAW --enable MOH-OPSOUND-ALAW --enable MOH-OPSOUND-GSM --enable MOH-OPSOUND-G729 --enable MOH-OPSOUND-G722 --enable res_chan_stats --enable res_mongodb --enable app_statsd --enable res_endpoint_stats --enable codec_opus --enable codec_g729a
